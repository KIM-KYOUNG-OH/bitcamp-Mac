...
//		this.getContentPane().setBackground(new Color(211, 225, 208)); // 프레임 위에 있는 패널의 색상변경
	...
	public void paint(Graphics g) {
		...
		// Image타입으로 생성하는 방법 2가지
		Image image1 = Toolkit.getDefaultToolkit().getImage("/Users/kimgyeong-o/bitcampJAVA/image/쇼핑몰사진/9.jpg");
		Image image2 = new ImageIcon("/Users/kimgyeong-o/bitcampJAVA/image/연예인사진/1.JPG").getImage();
